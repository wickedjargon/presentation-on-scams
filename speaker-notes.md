...
- The Big Picture: Actual annual losses likely exceed $6 Billion when accounting for unreported cases.

Graph Description / Speaker Notes:
> The following graph presents a dollar loss breakdown based on the total dollar loss for processed reports between 2020 and 2024. The CAFC has seen a steady increase in the total amount lost by victims since 2020, though the increase has slowed since 2022. Although there has been a decrease in the number of reports processed at the CAFC, the CAFC has been able to show an increase in total dollar loss by prioritizing its work around high-value and high-impact frauds.
...
- Note: The Canadian Anti-Fraud Centre publishes a report every year. This is the 2024 report; the 2025 report has not been published yet.

Graph Description / Speaker Notes:
> The following graph presents a solicitation method breakdown by dollar loss per communication mechanism. Cyber-Enabled Fraud relates to 4 of 13 solicitation methods captured at the CAFC, yet it accounts for $481.6 M in losses, making up 75% of the total dollar loss.
...
* Overall Increases: The CAFC saw increases in victimization within the Top 10 Frauds, with Bank Investigator Fraud (16.5%) and Phishing (6.8%) showing the largest increases. Extortion was the only fraud where a decrease was seen (10%).
* Investment Scams: Make up 49% of the overall dollar loss ($643,716,736 CAD) reported to CAFC.
* Extortion Impact: Although the CAFC saw a decrease in victimization with Extortion scams, there was a significant increase in the dollar amount lost by victims ($8.6M increase).
* Job Scams: The CAFC saw the largest increase in losses with job scams ($17M increase).
* Youth: Individuals aged 19 and under are more likely to be victimized by fraud.
* Seniors: The total amount lost by seniors (60+) makes up 40.3% of the overall dollar loss reported to CAFC.
* Identity Fraud: Impacts all ages, with those aged 30–39 victimized the most.
...
- Celebrity Variation: Scammers can also pose as celebrities reaching out to fans.
- The Grooming: After the scammer knows the victim is emotionally invested, they request money.
